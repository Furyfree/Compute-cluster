...
const mockVMs = [
  {
    id: "vm1",
    name: "Virtuel Maskine 1",
    ip: "Placeholder",
    status: "running (placeholder)",
    memory: "4 GB (placeholder)",
    cpu: "2 vCPU (placeholder)",
    disk: "40 GB (placeholder)",
  },
  {
    id: "vm2 ",
    name: "Virtuel Maskine 2",
    ip: "192.168.1.101 (placeholder)",
    status: "stopped (placeholder)",
    memory: "8 GB (placeholder)",
    cpu: "4 vCPU (placeholder)",
    disk: "100 GB (placeholder)",
  },
];
      ...
      <div className="flex h-[calc(100vh-80px)]">
        ...
        <main className="flex-1 p-6 space-y-6 overflow-y-auto">
          ...
          <div className="flex-1 min-h-[300px] h-full bg-black rounded overflow-hidden border border-dtu-grey dark:border-zinc-700">
            <iframe
              src={`http://compute-cluster-guacamole:8080/guacamole/#/client/1?token=DD7EA02DAEBFADD9E6E0C2FBEC778C2EFDAE2A7BD2FB6858D160CB07F35ACB97`}
              title="Guacamole"
